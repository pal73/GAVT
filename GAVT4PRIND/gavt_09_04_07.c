...
else if((!(in_word&(1<<PROG3)))&&(in_word&(1<<PROG2))&&(in_word&(1<<PROG1))/*&&(in_word&(1<<PROG4))*/)
	{
	temp_prog=p3;
	}

/*else if((!(in_word&(1<<PROG4)))&&(in_word&(1<<PROG2))&&(in_word&(1<<PROG3))&&(in_word&(1<<PROG1)))
	{
	prog=p4;
	}
...
if(temp_prog==p1)
	{
	if(eeprom_read(EE_PROGRAM)==p4)
		{
		prog=p4;
		}
	else if(eeprom_read(EE_PROGRAM)==p3)
		{
		prog=p4;
		eeprom_write(EE_PROGRAM,p4);
		}
	else if(eeprom_read(EE_PROGRAM)==p2)
		{
		prog=p1;
		eeprom_write(EE_PROGRAM,p1);
		}
	else
		{
		prog=p1;
		if(eeprom_read(EE_PROGRAM)!=p1)eeprom_write(EE_PROGRAM,p1);
		}
	}

else if(temp_prog==p2)
	{
	prog=p2;
	if(eeprom_read(EE_PROGRAM)!=p2)eeprom_write(EE_PROGRAM,p2);
	}

else if(temp_prog==p3)
	{
	prog=p3;
	if(eeprom_read(EE_PROGRAM)!=p3)eeprom_write(EE_PROGRAM,p3);
	}

if((prog==p1)||(prog==p2)) sub_ind=0;
