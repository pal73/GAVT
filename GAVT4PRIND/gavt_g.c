...
char enum{p1=1,p2=2,p3=3,p4=4,pOFF=77}prog=p1;
...
void prog_drv(void)
{
if((!(in_word&(1<<PROG1)))&&(in_word&(1<<PROG2))&&(in_word&(1<<PROG3))&&(in_word&(1<<PROG4)))
	{
	prog=p1;
	}
else if((!(in_word&(1<<PROG2)))&&(in_word&(1<<PROG1))&&(in_word&(1<<PROG3))&&(in_word&(1<<PROG4)))
	{
	prog=p2;
	}
