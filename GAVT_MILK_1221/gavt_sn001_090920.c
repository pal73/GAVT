...
char ind_cnt;
flash char IND_STROB[]={0b10111111,0b11011111,0b11101111,0b11111111,0b01111111};
...
if(ind_cnt<5)
	...
	if (bERR/*(ind_out[ind_cnt]&0x01*/)PORTD.3=0;
	else PORTD.3=1;
	//PORTD.3=0;
	}
else but_drv();
